...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.toon = Toon('ri', 'ls', False, 'ms', 'l', 'f', head_color='Periwinkle', arm_color='Periwinkle', leg_color='Periwinkle', animation_type='riggyWalk', shirt_texture='Beta Bug Hunter Shirt', backpack="The Flunk-Trunk", glasses='ToonFest 2020 Blue Attendee Glasses', is60FPS=True)
