...
# THIRD PAGE
        ...
        ), 'Backpack:', -0.1, 0.6, 24, backpack_dict, self.updateBackpack, 0)

        textEntryGui = self.optionsGeom.find('**/*ttr_t_gui_gen_buttons_box')
        hatPositioningLabel = OptionsLabel(self.thirdPageOptionsScroll.getCanvas(), "Hat Placement", -0.75)
        backpackPositioningLabel = OptionsLabel(self.thirdPageOptionsScroll.getCanvas(), "Backpack Placement", -1.20)
        glassesPositioningLabel = OptionsLabel(self.thirdPageOptionsScroll.getCanvas(), "Glasses Placement", -1.65)
# - 3.75
# Hat Frames
        self.hatXFrame = DirectFrame(
            parent = self.thirdPageOptionsScroll.getCanvas(),
            geom = textEntryGui,
            relief=None,
            scale=(0.15,0.15,0.15),
            text='x position',
            text_font = self.modalFont,#self.modalFont,
            text_scale=0.5,
            text_pos=(0,0.5,0),
            pos = (-0.775, 0, -0.95)
        )
...
# Backpack frames
        ...
        self.backpackXEntry = DirectEntry(
            ...
            relief=None,
            command=self.updateBackpackXPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.backpackYEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateBackpackYPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.backpackZEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateBackpackZPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.backpackScaleEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateBackpackScale,
            pos=(-0.5,0,-0.08)
        )
...
# Glasses frames
        ...
        self.glassesXEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateGlassesXPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.glassesYEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateGlassesYPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.glassesZEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateGlassesZPos,
            pos=(-0.5,0,-0.08)
        )
        ...
        self.glassesScaleEntry = DirectEntry(
            ...
            frameSize=(-0.2,1.25,-0.55,0.2),
            relief=None,
            command=self.updateGlassesScale,
            pos=(-0.5,0,-0.08)
        )
...
# Toon DNA related functions
    ...
    def smoothanimationToggle(self):
        if self.selectedToon.smoothEnabled:
            self.selectedToon.toonActor.setBlend(frameBlend=False)
            self.selectedToon.smoothEnabled = False
        else:
    ...
    def shoesToggle(self):
        if self.selectedToon.wearsShoes:
            ...
            self.selectedToon.attachShoes(self.selectedToon.shoeType)
...
# Accessory related functions
    ...
    def updateBackpack(self, backpack_type):
        self.selectedToon.backpackType = backpack_type
    ...
    def updateGlasses(self, glasses_type):
        self.selectedToon.glassesType = glasses_type
...
# Clothing related functions
    ...
    def updateShirtTexture(self, shirt_texture):
        self.selectedToon.shirtTexture = shirt_texture
    ...
    def updateShortTexture(self, short_texture):
        self.selectedToon.shortTexture = short_texture
    ...
    def updateSkirtTexture(self, skirt_texture):
        self.selectedToon.skirtTexture = skirt_texture
    ...
    def updateShirtColor(self, shirt_color):
        self.selectedToon.shirtColor = shirt_color
    ...
    def updateBottomColor(self, bottom_color):
        self.selectedToon.bottomColor = bottom_color
    ...
    def updateShoeTexture(self, shoe_texture):
        try:
            self.selectedToon.shoeTexture = shoe_texture
    ...
    def updateShortBootTexture(self, shoe_texture):
        try:
            self.selectedToon.shortBootTexture = shoe_texture
    ...
    def updateLongBootTexture(self, shoe_texture):
        try:
            self.selectedToon.longBootTexture = shoe_texture
    ...
    def updateShoes(self):
        ...
        if tested_value >= 0 and tested_value <= 25:
            self.selectedToon.shoeType = 4
            self.selectedToon.hideShoePieces()
        elif tested_value > 25 and tested_value <= 50:
            self.selectedToon.shoeType = 1
            self.selectedToon.attachShoes(self.selectedToon.shoeType)
        elif tested_value > 50 and tested_value <= 75:
            self.selectedToon.shoeType = 2
            self.selectedToon.attachShoes(self.selectedToon.shoeType)
        else:
            self.selectedToon.shoeType = 3
            self.selectedToon.attachShoes(self.selectedToon.shoeType)
